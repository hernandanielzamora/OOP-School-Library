...
School library is a project that mocks up the functionality of an University Library, where we need to record what books are in the library and who borrows them. The project is built following this UML class diagram.
<img src="https://github.com/microverseinc/curriculum-ruby/raw/main/oop/images/uml_class_diagram.png" />
...
- **[User can Add new students or teachers]**
- **[User can Add new books]**
- **[The project save records of who borrowed a book and when]**

<!-- Getting Started -->

## Getting Started

This repository includes several files with plain SQL and another ones with Ruby. Check out the letters after the "." in each file.
